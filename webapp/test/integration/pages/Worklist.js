sap.ui.define([
		...
		"assertcode/CommesseApplication/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									id: oBindingContext.getProperty("NumeroOrdine"),
									name: oBindingContext.getProperty("NumeroOrdine")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all ordineSet to be able to check for the total amount
