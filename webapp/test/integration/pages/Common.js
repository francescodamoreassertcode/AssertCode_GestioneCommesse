sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("assertcode/CommesseApplication/app", ".html");
		...
		return Opa5.extend("assertcode.CommesseApplication.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["assertcode/CommesseApplication/localService/mockserver"], function (mockserver) {
